...
<script type="text/html" data-template-name="ui_widget_thermometer">
    ...
    <div class="containerBox" style="color: #555;">
        ...
        <div class="form-row">
            <label style="width: 140px;" for="node-input-numColor"><i class="fa fa-info-circle"></i> <span data-i18n="ui_widget_thermometer.label.numColor"></span></label>
        ...
        <div class="form-row" id="row-colorBottom">
            <label style="width: 140px;" for="node-input-colorBottom"><i class="fa fa-paint-brush"></i> <span id="lbl-bottomColor" data-i18n="ui_widget_thermometer.label.bottomAreaColor"></span><span id="lbl-singleColor" data-i18n="ui_widget_thermometer.label.singleColor"></span></label>
